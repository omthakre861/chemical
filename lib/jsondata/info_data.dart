...
class Record {
  ...
  factory Record.fromJson(Map<String, dynamic> json) => Record(
        ...
        recordNumber:
            json["RecordNumber"] == null ? null : json["RecordNumber"],
        recordTitle: json["RecordTitle"] == null ? null : json["RecordTitle"],
        section: json["Section"] == null
            ? null
            : List<RecordSection>.from(
                json["Section"].map((x) => RecordSection.fromJson(x))),
      );
...
class RecordSection {
  ...
  factory RecordSection.fromJson(Map<String, dynamic> json) => RecordSection(
        ...
        section: json["Section"] == null
            ? null
            : List<PurpleSection>.from(
                json["Section"].map((x) => PurpleSection.fromJson(x))),
        displayControls: json["DisplayControls"] == null
            ? null
            : PurpleDisplayControls.fromJson(json["DisplayControls"]),
        information: json["Information"] == null
            ? null
            : List<PurpleInformation>.from(
                json["Information"].map((x) => PurpleInformation.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "Section": section == null
            ...
            : List<dynamic>.from(section.map((x) => x.toJson())),
        "DisplayControls":
            displayControls == null ? null : displayControls.toJson(),
        "Information": information == null
            ? null
            : List<dynamic>.from(information.map((x) => x.toJson())),
      };
}
...
class PurpleDisplayControls {
  ...
  factory PurpleDisplayControls.fromJson(Map<String, dynamic> json) =>
      PurpleDisplayControls(
        hideThisSection:
            json["HideThisSection"] == null ? null : json["HideThisSection"],
...
class PurpleInformation {
  ...
  factory PurpleInformation.fromJson(Map<String, dynamic> json) =>
      PurpleInformation(
        name: json["Name"] == null ? null : json["Name"],
        value:
            json["Value"] == null ? null : PurpleValue.fromJson(json["Value"]),
      );
...
class PurpleValue {
  ...
  factory PurpleValue.fromJson(Map<String, dynamic> json) => PurpleValue(
        stringWithMarkup: json["StringWithMarkup"] == null
            ? []
            : List<PurpleStringWithMarkup>.from(json["StringWithMarkup"]
                .map((x) => PurpleStringWithMarkup.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "StringWithMarkup": stringWithMarkup == null
            ? []
            : List<dynamic>.from(stringWithMarkup.map((x) => x.toJson())),
      };
}
...
class PurpleStringWithMarkup {
  ...
  factory PurpleStringWithMarkup.fromJson(Map<String, dynamic> json) =>
      PurpleStringWithMarkup(
        string: json["String"] == null ? [] : json["String"],
        markup: json["Markup"] == null
            ? []
            : List<PurpleMarkup>.from(
                json["Markup"].map((x) => PurpleMarkup.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "Markup": markup == null
            ? []
            : List<dynamic>.from(markup.map((x) => x.toJson())),
      };
}
...
class PurpleSection {
  ...
  factory PurpleSection.fromJson(Map<String, dynamic> json) => PurpleSection(
        ...
        information: json["Information"] == null
            ? null
            : List<FluffyInformation>.from(
                json["Information"].map((x) => FluffyInformation.fromJson(x))),
        section: json["Section"] == null
            ? null
            : List<FluffySection>.from(
                json["Section"].map((x) => FluffySection.fromJson(x))),
      );
...
class FluffyInformation {
  ...
  factory FluffyInformation.fromJson(Map<String, dynamic> json) =>
      FluffyInformation(
        value:
            json["Value"] == null ? null : FluffyValue.fromJson(json["Value"]),
        name: json["Name"] == null ? null : json["Name"],
      );
...
class FluffyValue {
  ...
  factory FluffyValue.fromJson(Map<String, dynamic> json) => FluffyValue(
        boolean: json["Boolean"] == null
            ? null
            : List<bool>.from(json["Boolean"].map((x) => x)),
        stringWithMarkup: json["StringWithMarkup"] == null
            ? null
            : List<FluffyStringWithMarkup>.from(json["StringWithMarkup"]
                .map((x) => FluffyStringWithMarkup.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "Boolean":
            boolean == null ? null : List<dynamic>.from(boolean.map((x) => x)),
        "StringWithMarkup": stringWithMarkup == null
            ? null
            : List<dynamic>.from(stringWithMarkup.map((x) => x.toJson())),
      };
...
class FluffyStringWithMarkup {
  ...
  factory FluffyStringWithMarkup.fromJson(Map<String, dynamic> json) =>
      FluffyStringWithMarkup(
...
class FluffySection {
  ...
  factory FluffySection.fromJson(Map<String, dynamic> json) => FluffySection(
        ...
        information: json["Information"] == null
            ? null
            : List<TentacledInformation>.from(json["Information"]
                .map((x) => TentacledInformation.fromJson(x))),
        displayControls: json["DisplayControls"] == null
            ? null
            : FluffyDisplayControls.fromJson(json["DisplayControls"]),
      );
...
class FluffyDisplayControls {
  ...
  factory FluffyDisplayControls.fromJson(Map<String, dynamic> json) =>
      FluffyDisplayControls(
...
class TentacledInformation {
  ...
  factory TentacledInformation.fromJson(Map<String, dynamic> json) =>
      TentacledInformation(
        value: json["Value"] == null
            ? null
            : TentacledValue.fromJson(json["Value"]),
        name: json["Name"] == null ? null : json["Name"],
      );
...
class TentacledValue {
  ...
  factory TentacledValue.fromJson(Map<String, dynamic> json) => TentacledValue(
        stringWithMarkup: json["StringWithMarkup"] == null
            ? null
            : List<TentacledStringWithMarkup>.from(json["StringWithMarkup"]
                .map((x) => TentacledStringWithMarkup.fromJson(x))),
        externalDataUrl: json["ExternalDataURL"] == null
            ? null
            : List<String>.from(json["ExternalDataURL"].map((x) => x)),
        mimeType: json["MimeType"] == null ? null : json["MimeType"],
        number: json["Number"] == null
            ? null
            : List<double>.from(json["Number"].map((x) => x.toDouble())),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "ExternalDataURL": externalDataUrl == null
            ? null
            : List<dynamic>.from(externalDataUrl.map((x) => x)),
...
class TentacledStringWithMarkup {
  ...
  factory TentacledStringWithMarkup.fromJson(Map<String, dynamic> json) =>
      TentacledStringWithMarkup(
        string: json["String"] == null ? null : json["String"],
        markup: json["Markup"] == null
            ? null
            : List<FluffyMarkup>.from(
                json["Markup"].map((x) => FluffyMarkup.fromJson(x))),
      );
